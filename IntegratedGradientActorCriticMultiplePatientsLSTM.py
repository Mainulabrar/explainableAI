...
for patient in test_set:
    ...
    np.savetxt(f'/data2/mainul/explainableAIResultsMultiplePatientCases/PaperInitdebug/backgroundForIGLSTM.txt', output.detach().numpy())
    ...
    for i in range(repSize-1):
        ...
        if i != 0:
           hx = torch.tensor(np.load(f'/data2/mainul/explainableAIResultsMultiplePatientCases/PaperInitdebug/dataWithPlanscoreRun/{patient}hx120499step{i-1}.npy'))
           cx = torch.tensor(np.load(f'/data2/mainul/explainableAIResultsMultiplePatientCases/PaperInitdebug/dataWithPlanscoreRun/{patient}cx120499step{i-1}.npy'))
        print(state.shape)
        ig = IntegratedGradients(model)
        ...
        # np.savetxt(f'/data2/mainul/explainableAIResultsMultiplePatientCases/PaperInitdebug/{patient}attributionStateRep{i}.txt', attributions[0].numpy())
        # np.savetxt(f'/data2/mainul/explainableAIResultsMultiplePatientCases/PaperInitdebug/{patient}attributionhxRep{i}.txt', attributions[1].numpy())
        # np.savetxt(f'/data2/mainul/explainableAIResultsMultiplePatientCases/PaperInitdebug/{patient}attributioncxRep{i}.txt', attributions[2].numpy())

        np.savetxt(f'/data2/mainul/explainableAIResultsMultiplePatientCases/PaperInitdebug/{patient}attributionStateRep2nd{i}.txt', attributions[0].numpy())
        np.savetxt(f'/data2/mainul/explainableAIResultsMultiplePatientCases/PaperInitdebug/{patient}attributionhxRep2nd{i}.txt', attributions[1].numpy())
        np.savetxt(f'/data2/mainul/explainableAIResultsMultiplePatientCases/PaperInitdebug/{patient}attributioncxRep2nd{i}.txt', attributions[2].numpy())
