...
for patient in test_set:
    ...
    for i in range(repSize-1):
	    ...
	    IGvalues1st = np.loadtxt(f'/data2/mainul/explainableAIResultsMultiplePatientCases/PaperInit/{patient}attributionRep{i}.txt')
	    ...
	    # IGvalues2nd = np.loadtxt(f'/data2/mainul/explainableAIResultsMultiplePatientCases/PaperInit/{patient}attribution2ndRep{i}.txt')
	    ...
	    # vmin = min(IGvalues.min(), IGvalues2nd.min())
	    # vmax = max(IGvalues.max(), IGvalues2nd.max())
	    vmin = min(IGvalues1st.min(), IGvalues.min())
	    vmax = max(IGvalues1st.max(), IGvalues.max())
	    ...
	    # plt.savefig(f'/data2/mainul/explainableAIResultsMultiplePatientCases/PaperInit/figures/{patient}IGValuesGraphzeroBaseCombined{i}.png', dpi= 1200)
	    plt.savefig(f'/data2/mainul/explainableAIResultsMultiplePatientCases/PaperInit/figures/{patient}IGValuesGraphzeroBaseCombined2nd{i}.png', dpi= 1200)
