...
color = np.load('/data2/mainul/ExplainableAIResultsAllSteps/dataWithPlanscoreRun/perturbationSpreadAll.npy')
...
for i in range(color.shape[0]):
	...
	# plt.savefig(f'/data2/mainul/ExplainableAIResultsAllSteps/figures/0Saliency{i}Perturbationspread.png', dpi= 1200)
	plt.savefig(f'/data2/mainul/ExplainableAIResultsAllSteps/figures/0Saliency{i}Perturbationspreadfulline.png', dpi= 1200)
