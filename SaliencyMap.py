        ...
        if done:
            ...
            if patientid == 0:
                ...
                while (planScore >= 6):
                    ...
                    planscoresSavePath = '/data2/mainul/ExplainableAIResults/planscores/'
                    os.makedirs(planscoresSavePath, exist_ok = True)
                    data_result_path='/data2/mainul/ExplainableAIResults/dataWithPlanscoreRun/'
                ...
                data_result_path='/data2/mainul/ExplainableAIResults/dataWithPlanscoreRun/'
                planscoresSavePath = '/data2/mainul/ExplainableAIResults/planscores/'
                actionSavePath = '/data2/mainul/ExplainableAIResults/actions/'
