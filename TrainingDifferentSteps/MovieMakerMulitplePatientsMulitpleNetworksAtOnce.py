...
for patient in test_set:
    ...
    for step in range(repSize-1):
        image_files = [f"/data2/mainul/explainableAIResultsMultiplePatientCases/AllTrainingSteps/PaperInitLSTM{net}/figuresJet/{patient}IGValuesLSTMGraphCombinedStep{step}.png" for net in NetSet]
        ...
        clip.write_videofile(f"{patient}animationIGLSTMStep{step}thStepAllNet.mp4", codec="mpeg4")      
