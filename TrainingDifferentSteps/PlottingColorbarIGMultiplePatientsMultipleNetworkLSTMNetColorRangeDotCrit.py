...
for patient in test_set:
    ...
    for i in range(repSize-1):
        ...
        for net in NetSet:      
            IGforColor = np.loadtxt(f'/data2/mainul/explainableAIResultsMultiplePatientCases/AllTrainingSteps/PaperInitLSTM{net}/{patient}attributionStateRep{i}.txt')
        ...
        for net in NetSet:
            ...
            plt.scatter(x_ptv, y_ptv, c = ColorPTV, vmin=vmin, vmax=vmax, cmap = 'jet')
            plt.scatter(x_bladder, y_bladder, c =  ColorBladder, vmin=vmin, vmax=vmax, cmap = 'jet')
            plt.scatter(x_rectum, y_rectum, c = ColorRectum, vmin=vmin, vmax=vmax, cmap = 'jet')

            plt.colorbar()

            plt.scatter(ProknowDoseBla, ProknowVolumeOAR, marker = '^', color = 'black', label = 'Bladder Criterion')
            plt.scatter(ProknowDoseRec, ProknowVolumeOAR, marker = 's', color = 'black', label = 'Rectum Criterion')
            plt.scatter(ProknowDosePTV, ProKnowVolumPTV, marker = '*', color = 'black', label = 'PTV Criterion')
            ...
            figureSavePath = f'/data2/mainul/explainableAIResultsMultiplePatientCases/AllTrainingSteps/PaperInitLSTM{net}/figuresJet/'
            os.makedirs(figureSavePath, exist_ok = True)
            plt.savefig(f'/data2/mainul/explainableAIResultsMultiplePatientCases/AllTrainingSteps/PaperInitLSTM{net}/figuresJet/{patient}IGValuesLSTMGraphCombinedStep{i}.png', dpi= 1200)
