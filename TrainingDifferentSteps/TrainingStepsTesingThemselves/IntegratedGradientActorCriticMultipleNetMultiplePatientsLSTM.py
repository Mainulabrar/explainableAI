...
for net in NetSet:
    ...
    for patient in test_set:
        Y = np.load(f"/data2/mainul/explainableAIResultsMultiplePatientCases/AllTrainingStepsThemSelves/PaperInitLSTM{net}/dataWithPlanscoreRun/{patient}tpptuning120499.npz")
        ...
        np.savetxt(f'/data2/mainul/explainableAIResultsMultiplePatientCases/AllTrainingStepsThemSelves/PaperInitLSTM{net}/backgroundForIGLSTM.txt', output.detach().numpy())

        # for i in range(repSize-1):
        for i in range(repSize-1):
            print('i', i)
            state = state_to_tensor(np.load(f'/data2/mainul/explainableAIResultsMultiplePatientCases/AllTrainingStepsThemSelves/PaperInitLSTM{net}/dataWithPlanscoreRun/{patient}xDVHY120499step{i}.npy'))
            if i != 0:
               hx = torch.tensor(np.load(f'/data2/mainul/explainableAIResultsMultiplePatientCases/AllTrainingStepsThemSelves/PaperInitLSTM{net}/dataWithPlanscoreRun/{patient}hx120499step{i-1}.npy'))
               cx = torch.tensor(np.load(f'/data2/mainul/explainableAIResultsMultiplePatientCases/AllTrainingStepsThemSelves/PaperInitLSTM{net}/dataWithPlanscoreRun/{patient}cx120499step{i-1}.npy'))
            print(state.shape)
            ig = IntegratedGradients(model)
            ...
            np.savetxt(f'/data2/mainul/explainableAIResultsMultiplePatientCases/AllTrainingStepsThemSelves/PaperInitLSTM{net}/{patient}attributionStateRep{i}.txt', attributions[0].numpy())
            np.savetxt(f'/data2/mainul/explainableAIResultsMultiplePatientCases/AllTrainingStepsThemSelves/PaperInitLSTM{net}/{patient}attributionhxRep{i}.txt', attributions[1].numpy())
            np.savetxt(f'/data2/mainul/explainableAIResultsMultiplePatientCases/AllTrainingStepsThemSelves/PaperInitLSTM{net}/{patient}attributioncxRep{i}.txt', attributions[2].numpy())

            # np.savetxt(f'/data2/mainul/explainableAIResultsMultiplePatientCases/AllTrainingStepsThemSelves/PaperInitLSTM{net}/{patient}attributionStateRep2nd{i}.txt', attributions[0].numpy())
            # np.savetxt(f'/data2/mainul/explainableAIResultsMultiplePatientCases/AllTrainingStepsThemSelves/PaperInitLSTM{net}/{patient}attributionhxRep2nd{i}.txt', attributions[1].numpy())
            # np.savetxt(f'/data2/mainul/explainableAIResultsMultiplePatientCases/AllTrainingStepsThemSelves/PaperInitLSTM{net}/{patient}attributioncxRep2nd{i}.txt', attributions[2].numpy())
