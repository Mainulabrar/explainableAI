...
for net in NetSet:
	...
	for patient in test_set:
	    ...
	    for j in range(repSize-1):
		    Y = np.load(f'/data2/mainul/explainableAIResultsMultiplePatientCases/AllTrainingStepsThemSelves/PaperInitLSTM{net}/dataWithPlanscoreRun/{patient}xDVHY120499step{j}.npy')
		    IGforColor = np.loadtxt(f'/data2/mainul/explainableAIResultsMultiplePatientCases/AllTrainingStepsThemSelves/PaperInitLSTM{net}/{patient}attributionStateRep{j}.txt')
