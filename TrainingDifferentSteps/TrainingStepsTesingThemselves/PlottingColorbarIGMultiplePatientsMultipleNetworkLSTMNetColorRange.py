...
for patient in test_set:
    ...
    for i in range(repSize-1):
        ...
        for net in NetSet:
			...
			# figureSavePath = f'/data2/mainul/explainableAIResultsMultiplePatientCases/AllTrainingStepsThemSelves/PaperInitLSTM{net}/figures/'
			# os.makedirs(figureSavePath, exist_ok = True)
			# plt.savefig(f'/data2/mainul/explainableAIResultsMultiplePatientCases/AllTrainingStepsThemSelves/PaperInitLSTM{net}/figures/{patient}IGValuesLSTMGraphCombinedStep{i}.png', dpi= 1200)
