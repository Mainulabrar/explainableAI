            ...
            for patientid in range(len(pid)):
                ...
                while True:
                    ...
                    if done:
                        ...
                        planscoresSavePath = '/data2/mainul/explainableAIResultsMultiplePatientCases/AllTrainingStepsThemSelves/PaperInitLSTM0/planscores/'
                        os.makedirs(planscoresSavePath, exist_ok = True)
                        data_result_path='/data2/mainul/explainableAIResultsMultiplePatientCases/AllTrainingStepsThemSelves/PaperInitLSTM0/dataWithPlanscoreRun/'
