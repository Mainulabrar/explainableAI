            ...
            for patientid in range(len(pid)):
                ...
                while True:
                    ...
                    if done:
                        ...
                        planscoresSavePath = '/data2/mainul/explainableAIResultsMultiplePatientCases/AllTrainingStepsThemSelves/PaperInitLSTM159999/planscores/'
                        os.makedirs(planscoresSavePath, exist_ok = True)
                        data_result_path='/data2/mainul/explainableAIResultsMultiplePatientCases/AllTrainingStepsThemSelves/PaperInitLSTM159999/dataWithPlanscoreRun/'
                        ...
                        planscoresSavePath = '/data2/mainul/explainableAIResultsMultiplePatientCases/AllTrainingStepsThemSelves/PaperInitLST159999/planscores/'
                        os.makedirs(planscoresSavePath, exist_ok = True)
                        data_result_path='/data2/mainul/explainableAIResultsMultiplePatientCases/AllTrainingStepsThemSelves/PaperInitLSTM159999/dataWithPlanscoreRun/'
                        os.makedirs(data_result_path, exist_ok = True)
