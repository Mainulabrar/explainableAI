...
def test(rank, args, T):
    ...
    while T.value() <= args.T_max:
        if can_test:
            ...
            model.load_state_dict(torch.load('/home/mainul/Actor-critic-based-treatment-planning/acer_VTPN-12-18-23/results/results/episode5999.pth'))
            model.eval()
            ...
            for patientid in range(len(pid)):
                ...
                while True:
                    ...
                    if done:
                        ...
                        planscoresSavePath = '/data2/mainul/explainableAIResultsMultiplePatientCases/AllTrainingSteps/PaperInitLSTM5999/planscores/'
                        os.makedirs(planscoresSavePath, exist_ok = True)
                        data_result_path='/data2/mainul/explainableAIResultsMultiplePatientCases/AllTrainingSteps/PaperInitLSTM5999/dataWithPlanscoreRun/'
